...
import ModalFeedBackContent from "./component/ModalFeedBackContent";

export default function PageFeedBackForms() {
    ...
    const [toggleModalFeedBack, setToggleModalFeedBack] = useState({
        open: false,
        data: null,
    });
    ...
    return (
        <Card>
            ...
            <ModalFeedBackContent
                ...
                setToggleModalFeedBack={setToggleModalFeedBack}
            />
        </Card>
    );
}
